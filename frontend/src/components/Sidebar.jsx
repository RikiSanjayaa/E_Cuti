...
export function Sidebar({ isCollapsed, role = 'admin', isMobile, onClose }) {
  ...
  return (
    <>
      ...
      `}>
        {/* Header */}
        <div className={`h-20 flex items-center ${!isMobile && isCollapsed ? 'justify-center' : 'px-6'} border-b border-border transition-all duration-300`}>
          <div className="flex items-center gap-4 overflow-hidden whitespace-nowrap w-full">
            ...
            <div className={`transition-opacity duration-300 ${!isMobile && isCollapsed ? 'opacity-0 w-0' : 'opacity-100 w-auto'} flex-1`}>
