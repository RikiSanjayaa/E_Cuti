import { Search, Filter, Download, X, MapPin, TrendingUp } from 'lucide-react';
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border bg-muted/50">
                  <th className="text-left px-6 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">NRP</th>
                  <th className="text-left px-6 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">Nama</th>
                  <th className="text-left px-6 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">Pangkat</th>
                  <th className="text-left px-6 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">Jabatan</th>
                  <th className="text-left px-6 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">Satker</th>
                  <th className="text-left px-6 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wider">Sisa Cuti</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border">
                {loading ? (
                  ...
                  <tr><td colSpan="6" className="px-6 py-8 text-center text-muted-foreground">Tidak ada personel ditemukan.</td></tr>
                ) : (
                  filteredPersonnel.map((p) => (
                    ...
                    >
                      <td className="px-6 py-4 text-sm font-medium text-foreground">{p.nrp}</td>
                      <td className="px-6 py-4 text-sm text-foreground">{p.nama}</td>
                      <td className="px-6 py-4 text-sm text-muted-foreground">{p.pangkat}</td>
                      <td className="px-6 py-4 text-sm text-muted-foreground">{p.jabatan}</td>
                      <td className="px-6 py-4 text-sm text-foreground">{p.satker}</td>
                      <td className="px-6 py-4 text-sm font-medium text-foreground">12 hari</td>
                    </tr>
                  ))
                )}
              </tbody>
